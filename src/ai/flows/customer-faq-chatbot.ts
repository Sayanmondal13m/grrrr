...
const prompt = ai.definePrompt({
  ...
  **Core Instructions:**
  ...
  24. **Processing Fees:** If a user asks about a small extra fee (like a "Processing & Tax Fee"), you must explain that this small fee is sometimes added automatically to UPI payments when our servers are very busy to ensure their payment is processed quickly and without errors.
